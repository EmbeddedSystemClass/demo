...
unsigned portBASE_TYPE uxHighWaterMarku2send; 
...
void  U2SEND_TASK (void const * argument)
{
	  ...
	  osEvent evt;
    uint32_t n=0;
		uxHighWaterMarku2send=uxTaskGetStackHighWaterMark( U2SEND_TASK_Handle );    //查询大小  
	  PSDK_LOG_DEBUG("u2send_TASK  %d\r\n", uxHighWaterMarku2send );
	while (1) 
	{	            
