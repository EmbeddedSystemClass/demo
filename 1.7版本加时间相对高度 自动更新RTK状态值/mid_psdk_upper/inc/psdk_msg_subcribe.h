 ...
 */
typedef struct {
    void (*bandWidthMsgCallback)                (const T_BandWidthMsg *);           /*!< Data transmission bandwidth push callback function. */
    ...
    void (*utcTimestampMsgCallback)             (const T_UtcTimestampMsg *);        /*!< UTC timestamp push callback function. */
    void (*otherPayloadTypeMsgCallback)         (const T_OtherPayloadTypeMsg *);    /*!< type of other payload mounted on UAV
                                                                                         push callback function. */
    void (*otherPayloadFocalLengthMsgCallback)  (const T_OtherPayloadFocalLengthMsg *);
                                                                                    /*!< focal length of other payload mounted on UAV
                                                                                         push callback function. */
