...
void cocoguojia_oledShowShareuavLogoAndID(void)
{
    ...
    OLED_ShowString(95,0,(u8 *)SYS_VER_NUB);   //cocoguojia banben
	OLED_DrawBMP(48,2,80,7,(unsigned char*)BMP3); 
	//--------------------------------------
...
void cocoguojia_oledRunShowFor1(uint8_t offOnFlag)
{
	...
	//-------------------------------------------------
	//1-2 第一页第二行显示 ppsRtkHealthNum
    if(2==signalOrAutoModelFlag)
    {
        OLED_ShowString(0,2,"SIGNAL  RTK=    ");	
    }	
    else if(4==signalOrAutoModelFlag)
    {
    ...
    OLED_ShowNum(98,2,ppsRtkHealthNum,2,16);	
  		
	//-------------------------------------------------
	//1-3 第一页第三行显示	
	OLED_ShowString(0,4,"P:              ");	 
	tim5CatchNumTemp=tim5CatchNum;
	...
	if(10000<=photoPicNum[1])
	{
		i=5;
	}	
	if(1000<=photoPicNum[1])
	{
		i=4;
	}
	else if(100<=photoPicNum[1])
	{
		i=3;
	}
	else if(10<=photoPicNum[1])
	{
		i=2;
	}
	else 
	...
	OLED_ShowNum(41,6,photoPicNum[1],i+1,16);
}
...
void cocoguojia_oledRunShowFor2(void)
{
    ...
    //--------------------------------------------------------------
	//2-1 第二页第一行显示
	if(10000<=photoPicNum[2])
	{
		i=5;
	}	
	if(1000<=photoPicNum[2])
	{
		i=4;
	}
	else if(100<=photoPicNum[2])
	{
		i=3;
	}
	else if(10<=photoPicNum[2])
	{
		i=2;
	}
	else 
	...
	OLED_ShowNum(41,0,photoPicNum[2],i+1,16);
	
	//--------------------------------------------------------------
	//2-2 第二页第二行显示
	OLED_ShowString(0,2,"PIC3:           ");//一共可以写16个字符
	if(10000<=photoPicNum[3])
	{
		i=5;
	}	
	if(1000<=photoPicNum[3])
	{
		i=4;
	}
	else if(100<=photoPicNum[3])
	{
		i=3;
	}
	else if(10<=photoPicNum[3])
	{
		i=2;
	}
	else 
	...
	OLED_ShowNum(41,2,photoPicNum[3],i+1,16);	
	
	//--------------------------------------------------------------
	//2-3 第二页第三行显示
	OLED_ShowString(0,4,"PIC4:         ");//一共可以写16个字符
	if(10000<=photoPicNum[4])
	{
		i=5;
	}	
	if(1000<=photoPicNum[4])
	{
		i=4;
	}
	else if(100<=photoPicNum[4])
	{
		i=3;
	}
	else if(10<=photoPicNum[4])
	{
		i=2;
	}
	else 
	...
	OLED_ShowNum(41,4,photoPicNum[4],i+1,16);	
	
	//--------------------------------------------------------------
	//2-4 第二页第四行显示
	OLED_ShowString(0,6,"PIC5:           ");//一共可以写16个字符
	if(10000<=photoPicNum[5])
	{
		i=5;
	}	
	if(1000<=photoPicNum[5])
	{
		i=4;
	}
	else if(100<=photoPicNum[5])
	{
		i=3;
	}
	else if(10<=photoPicNum[5])
	{
		i=2;
	}
	else 
	...
	OLED_ShowNum(41,6,photoPicNum[5],i+1,16);	
}
...
void cocoguojia_oledShowSetModel1(void)
{
    ...
    else //if(0==currentRowNum) 进入修复模式 特殊模式
    {
