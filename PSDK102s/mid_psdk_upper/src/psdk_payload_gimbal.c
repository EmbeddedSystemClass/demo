...
/**
 * @brief Handle control gimbal angle command.
 * @param protHandle Pointer to PSDK protocol handle.
 * @param inProtInfo Pointer to PSDK protocol information of data package.
 * @param inProtData Pointer to data field of package.
 * @return PSDK function process state.
 */
MODLE_FUNC_GIMCMD(ControlAngle)

/**
 * @brief Handle control gimbal joint angle command.
 * @param protHandle Pointer to PSDK protocol handle.
 * @param inProtInfo Pointer to PSDK protocol information of data package.
 * @param inProtData Pointer to data field of package.
 * @return PSDK function process state.
 */
MODLE_FUNC_GIMCMD(ControlJointAngle)
...
/**
 * @brief Handle Get Gimbal Calibration Progress command.
 * @param protHandle Pointer to PSDK protocol handle.
 * @param inProtInfo Pointer to PSDK protocol information of data package.
 * @param inProtData Pointer to data field of package.
 * @return PSDK function process state.
 */
MODLE_FUNC_GIMCMD(GetCaliProgress)
...
static const T_PsdkProtCmdItem s_PayloadGimbalCmdList[] =
        {
                ...
                PSDK_PROT_CMD_ITEM(PSDK_CMDSET_GIMBAL, PSDK_GIMBAL_CMD_ID_CONTROL_ANGLE, GIMCMD(ControlAngle)),
                PSDK_PROT_CMD_ITEM(PSDK_CMDSET_GIMBAL, PSDK_GIMBAL_CMD_ID_CONTROL_JOINT_ANGLE, GIMCMD(ControlJointAngle)),
                PSDK_PROT_CMD_ITEM(PSDK_CMDSET_GIMBAL, PSDK_GIMBAL_CMD_ID_START_CALIBRATION, GIMCMD(StartCalibration)),
                PSDK_PROT_CMD_ITEM(PSDK_CMDSET_GIMBAL, PSDK_GIMBAL_CMD_ID_GET_CALIBRATION_PROGRESS, GIMCMD(GetCaliProgress)),
