...
T_PsdkPositioningGetPosAck writesdpos = {0};
static T_SyncedTime syncedTime = {0};
    ...
    E_PsdkStat psdkStat = PSDK_STAT_ERR;
					 ...
					 do {
					    ...
					    /*UTC时间复制*/
							...
							{                                
										ppsRtkHealthNum=getPosAck.posDetailInfo[i].positionSolutionProperty;
